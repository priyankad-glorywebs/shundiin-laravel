<input type="hidden" name="title" value="gallery-module">
<link href="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.5.1/min/dropzone.min.css" rel="stylesheet" />
       
{{-- <form class="multi-img-form" method="post" enctype="multipart/form-data">
    @csrf --}}
    <div class="form-group multi-img-form">
...
function getImageSizeFromBase64(base64Data) {
  ...
  Dropzone.options.documentDropzone = {
    ...
    success: function (file, response) {
      $('.multi-img-form').append('<input type="hidden" name="document[]" value="' + response.name + '">')
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        for (var i in data) {
          ...
          $('.multi-img-form').append('<input type="hidden" name="document[]" value="' + i + '">');
        }
      }
    });
  @endif
