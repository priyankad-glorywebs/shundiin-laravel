...
<body>
    ...
    <div class="modal fade" id="dialog" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" class="form-control 123">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary w-100"
                        data-dismiss="modal">{{ trans('laravel-filemanager::lfm.btn-close') }}</button>
    ...
    <script>
        ...
        function fileStoreData(file, actionData) {
            if (actionData == 'true') {
                var ActionUrl = "{{ route('admin.media.add-folder') }}";
            } else {
                var ActionUrl = "{{ route('admin.media.store_file') }}";
            }
            ...
            /*START AJAX*/
            let folder_id   = jQuery("#uploadForm input[name=folder_id]").val();
            let folder_name = folderName;
            let working_dir = jQuery("#uploadForm input[name=working_dir]").val();
